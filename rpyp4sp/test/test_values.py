...
def test_compare_structv():
    a = objects.StructV([(p4specast.AtomT('SIZE', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 8))), objects.NumV.fromstr('0', p4specast.IntT.INSTANCE, -1, p4specast.NumT(p4specast.IntT()))), (p4specast.AtomT('CONST', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 9))), objects.BoolV(True, -1, p4specast.BoolT()))], -1, p4specast.VarT(p4specast.Id('entry', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 17), p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 22))), []))
    b = objects.StructV([(p4specast.AtomT('SIZE', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 8))), objects.NumV.fromstr('0', p4specast.IntT.INSTANCE, 568, p4specast.NumT(p4specast.IntT()))), (p4specast.AtomT('CONST', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 9))), objects.BoolV(True, 569, p4specast.BoolT()))], 570, p4specast.VarT(p4specast.Id('entry', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 17), p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 22))), []))
    assert a.compare(b) == 0

    a = objects.StructV([(p4specast.AtomT('a', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 8))), objects.NumV.fromstr('0', p4specast.IntT.INSTANCE, -1, p4specast.NumT(p4specast.IntT()))), (p4specast.AtomT('CONST', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 9))), objects.BoolV(True, -1, p4specast.BoolT()))], -1, p4specast.VarT(p4specast.Id('entry', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 17), p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 22))), []))
    b = objects.StructV([(p4specast.AtomT('b', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 8))), objects.NumV.fromstr('0', p4specast.IntT.INSTANCE, 568, p4specast.NumT(p4specast.IntT()))), (p4specast.AtomT('CONST', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 9))), objects.BoolV(True, 569, p4specast.BoolT()))], 570, p4specast.VarT(p4specast.Id('entry', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 17), p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 22))), []))
    assert a.compare(b) == -1

    a = objects.StructV([(p4specast.AtomT('SIZE', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 8))), objects.NumV.fromstr('0', p4specast.IntT.INSTANCE, -1, p4specast.NumT(p4specast.IntT()))), (p4specast.AtomT('x', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 9))), objects.BoolV(True, -1, p4specast.BoolT()))], -1, p4specast.VarT(p4specast.Id('entry', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 17), p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 22))), []))
    b = objects.StructV([(p4specast.AtomT('SIZE', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 18, 8))), objects.NumV.fromstr('0', p4specast.IntT.INSTANCE, 568, p4specast.NumT(p4specast.IntT()))), (p4specast.AtomT('b', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 4), p4specast.Position('spec/4a2-typing-tblctx.watsup', 19, 9))), objects.BoolV(True, 569, p4specast.BoolT()))], 570, p4specast.VarT(p4specast.Id('entry', p4specast.Region(p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 17), p4specast.Position('spec/4a2-typing-tblctx.watsup', 53, 22))), []))
    assert a.compare(b) == 1
