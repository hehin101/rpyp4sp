...
def test_subtyp_nat():
    ...
    value = objects.NumV.fromstr('32', p4specast.IntT.INSTANCE, p4specast.NumT(p4specast.IntT()), 3)
...
def test_binop_num_sub_is_int():
    def mknat(val): return objects.NumV.fromstr(str(val), p4specast.NatT.INSTANCE, typ=p4specast.NumT(p4specast.NatT()))
...
def test_bin_plus():
    ...
    arg0 = objects.CaseV(p4specast.MixOp([[p4specast.AtomT('IntV', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 13, 4), p4specast.Position('spec/2b2-runtime-value.watsup', 13, 8)))], []]), [objects.NumV.fromstr('5', p4specast.IntT.INSTANCE, p4specast.NumT(p4specast.IntT()), 2)], 220, p4specast.VarT(p4specast.Id('val', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 7, 7), p4specast.Position('spec/2b2-runtime-value.watsup', 7, 10))), []))

    arg1 = objects.CaseV(p4specast.MixOp([[p4specast.AtomT('IntV', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 13, 4), p4specast.Position('spec/2b2-runtime-value.watsup', 13, 8)))], []]), [objects.NumV.fromstr('3', p4specast.IntT.INSTANCE, p4specast.NumT(p4specast.IntT()), 5)], 231, p4specast.VarT(p4specast.Id('val', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 7, 7), p4specast.Position('spec/2b2-runtime-value.watsup', 7, 10))), []))

    res = objects.CaseV(p4specast.MixOp([[p4specast.AtomT('IntV', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 13, 4), p4specast.Position('spec/2b2-runtime-value.watsup', 13, 8)))], []]), [objects.NumV.fromstr('8', p4specast.IntT.INSTANCE, p4specast.NumT(p4specast.IntT()), 240)], 241, p4specast.VarT(p4specast.Id('val', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 7, 7), p4specast.Position('spec/2b2-runtime-value.watsup', 7, 10))), []))
    ctx, value = interp.invoke_func_def_attempt_clauses(ctx, func, [arg0, arg1])
    assert value.eq(res)
...
def test_conse_fresh_tids():
    name = 'fresh_tids'
    input_values = [objects.NumV.fromstr('1', p4specast.NatT.INSTANCE, p4specast.NumT(p4specast.NatT()), 8286)]
...
def test_check_arity():
    ...
    res = objects.BoolV(True, p4specast.BoolT(), 4819)
    ctx = make_context()
    func = ctx.glbl.fenv[name]
    ...
    res = objects.BoolV(False, p4specast.BoolT(), 4803)
