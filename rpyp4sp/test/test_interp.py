...
def test_subtyp_nat():
    ...
    value = objects.NumV.fromstr('32', p4specast.IntT.INSTANCE, p4specast.NumT.INT, 3)
...
def test_upcast_list():
    ...
    value = objects.ListV([], p4specast.IterT(p4specast.VarT(p4specast.Id('paramtyp', p4specast.Region.line_span('spec/2c1-runtime-type.watsup', 18, 9, 17)), []), p4specast.List()), -1)
    res = interp.upcast(None, typ, value)
    assert res is value
...
def test_bin_plus():
    ...
    res = objects.CaseV.make([objects.NumV.fromstr('8', p4specast.IntT.INSTANCE, p4specast.NumT.INT, 240)], p4specast.MixOp([[p4specast.AtomT('IntV', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 13, 4), p4specast.Position('spec/2b2-runtime-value.watsup', 13, 8)))], []]), 241, p4specast.VarT(p4specast.Id('val', p4specast.Region(p4specast.Position('spec/2b2-runtime-value.watsup', 7, 7), p4specast.Position('spec/2b2-runtime-value.watsup', 7, 10))), []))
    ctx, value = interp.untuple(interp.invoke_func_def_attempt_clauses(ctx, func, [arg0, arg1]))
    assert value.eq(res)
...
def test_concat_text():
    ...
    ctx, value = interp.untuple(interp.invoke_func_def_attempt_clauses(ctx, func, input_values))
    assert value.eq(expected)
...
def test_type_alpha():
    input_values = [objects.CaseV.make([objects.TextV('metadata', 501, p4specast.VarT(p4specast.Id('id', p4specast.NO_REGION), [])), objects.ListV([], 88162, p4specast.IterT(p4specast.TupleT([p4specast.VarT(p4specast.Id('member', p4specast.Region(p4specast.Position('spec/1a-syntax-el.watsup', 35, 7), p4specast.Position('spec/1a-syntax-el.watsup', 35, 13))), []), p4specast.VarT(p4specast.Id('typ', p4specast.Region(p4specast.Position('spec/2c3-runtime-type-subst.watsup', 16, 29), p4specast.Position('spec/2c3-runtime-type-subst.watsup', 16, 32))), [])]), p4specast.List()))], p4specast.MixOp([[p4specast.AtomT('StructT', p4specast.Region(p4specast.Position('spec/2c1-runtime-type.watsup', 66, 4), p4specast.Position('spec/2c1-runtime-type.watsup', 66, 11)))], [], []]), 88163, p4specast.VarT(p4specast.Id('datatyp', p4specast.Region(p4specast.Position('spec/2c1-runtime-type.watsup', 59, 7), p4specast.Position('spec/2c1-runtime-type.watsup', 59, 14))), [])), objects.CaseV.make([objects.TextV('metadata', 501, p4specast.VarT(p4specast.Id('id', p4specast.NO_REGION), [])), objects.ListV([], 88197, p4specast.IterT(p4specast.TupleT([p4specast.VarT(p4specast.Id('member', p4specast.Region(p4specast.Position('spec/1a-syntax-el.watsup', 35, 7), p4specast.Position('spec/1a-syntax-el.watsup', 35, 13))), []), p4specast.VarT(p4specast.Id('typ', p4specast.Region(p4specast.Position('spec/2c3-runtime-type-subst.watsup', 16, 29), p4specast.Position('spec/2c3-runtime-type-subst.watsup', 16, 32))), [])]), p4specast.List()))], p4specast.MixOp([[p4specast.AtomT('StructT', p4specast.Region(p4specast.Position('spec/2c1-runtime-type.watsup', 66, 4), p4specast.Position('spec/2c1-runtime-type.watsup', 66, 11)))], [], []]), 88198, p4specast.VarT(p4specast.Id('datatyp', p4specast.Region(p4specast.Position('spec/2c1-runtime-type.watsup', 59, 7), p4specast.Position('spec/2c1-runtime-type.watsup', 59, 14))), []))]
    name = 'Type_alpha'
    ctx = make_context()
